...
Two ZeroMQ sockets, same design as clMag:
...
Ports differ from the magnet service so both can run on the same machine.
"""
...
DEFAULT_CMD_PORT = 5557        # magnet uses 5555
DEFAULT_PUB_PORT = 5558        # magnet uses 5556
