...
hf2 adds ONE module-specific key, `ch2`: channel 1 is drawn in the amber accent
and channel 2 in a cyan that is distinguishable from it in both themes and to
the common forms of colour blindness (amber vs blue, not red vs green).
"""
