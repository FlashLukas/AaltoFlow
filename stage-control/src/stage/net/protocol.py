...
pub = cmd + 1.  The stage is instrument #2 -> 5559 / 5560.
"""
...
DEFAULT_CMD_PORT = 5559  # REP (commands)
DEFAULT_PUB_PORT = 5560  # PUB (status + events)
...
# -- status --------------------------------------------------------------- #
def status_to_dict(s: StageStatus) -> dict:
    """StageStatus -> plain dict for the PUB frame / a `status` reply."""
    return asdict(s)
